...
if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
    ...
    header('Location: manageplatinum.php');
    exit;
}
    ...
    <tbody>
        <?php foreach ($products as $product): ?>
            <tr>
                ...
                <td>
                    <a href="editplatinum.php?id=<?php echo $product['_id']; ?>">Edit</a> |
                    <a href="manageplatinum.php?action=delete&id=<?php echo $product['_id']; ?>" onclick="return confirm('Are you sure you want to delete this product?')">Delete</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
<a href="addplatinum.php" target="_blank">Add New Product</a>
</body>
</html>
